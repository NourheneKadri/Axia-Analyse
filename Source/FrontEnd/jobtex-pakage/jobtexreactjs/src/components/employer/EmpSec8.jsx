  ...
  useEffect(() => {
    const fetchCandidacies = async () => {
      try {
        ...
        const filteredCandidacies = candidaciesData.filter(candidacy => candidacy.candidateProfileId === user.userAccountId);
